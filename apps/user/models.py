...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(choices=(('register', u'注册'),
                                          ('forget', u'找回密码'),
                                          ('update_email', u'修改邮箱')), max_length=20, verbose_name=u'验证码类型')
...
class Banner(models.Model):
    ...
    bg_image = models.ImageField(max_length=100, upload_to='banner/%Y/%m', verbose_name=u'背景图', default='image/default')
